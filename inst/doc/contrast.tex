...
%
\ctable[ caption={A summary of the diet experimental design}, label=designSummary1, pos=h, ]{llr} {} {\FL\multicolumn{1}{c}{Diet}&
...
%
\ctable[ caption={A summary of the stem cell experimental design}, label=example2Table, pos=h, ]{llr} {} {\FL\multicolumn{1}{c}{Day}&
\multicolumn{1}{c}{Configuration}&
\multicolumn{1}{c}{Number of Donors}
\ML
1&A&$3$\NN
2&A&$0$\NN
4&A&$0$\NN
